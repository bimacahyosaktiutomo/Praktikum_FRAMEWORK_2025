        ...
        <li>
            <a href="{{ route('student.index') }}"
                class="flex items-center gap-3 px-3 py-2 border-2 border-rose-800 transition ease-in-out duration-100 hover:translate-x-1
                        {{ request()->routeIs('student.index*') ? 'bg-rose-800 text-rose-50 ' : 'hover:bg-rose-100 hover:text-rose-800' }}">
                <span>Mahasiswa</span>
            </a>
        </li>
        <li>
            <a href="{{ route('lecturer.index') }}"
                class="flex items-center gap-3 px-3 py-2 border-2 border-rose-800 transition ease-in-out duration-100 hover:translate-x-1
                        {{ request()->routeIs('lecturer.index*') ? 'bg-rose-800 text-rose-50 ' : 'hover:bg-rose-100 hover:text-rose-800' }}">
                <span>Dosen</span>
            </a>
        </li>

        {{-- Ini comment sebelum dipush --}}
        <li>
        ...
        <li class="flex-1 text-center">
            <a href="{{ route('student.index') }}"
                class="flex flex-col items-center justify-center py-2 transition ease-in-out duration-300
                        {{ request()->routeIs('student.index*') ? 'text-rose-50 bg-rose-800' : 'hover:bg-rose-100 hover:text-rose-800' }}">
                <span>Mahasiswa</span>
            </a>
        </li>
        <li class="flex-1 text-center">
            <a href="{{ route('lecturer.index') }}"
                class="flex flex-col items-center justify-center py-2 transition ease-in-out duration-300
                        {{ request()->routeIs('lecturer.index*') ? 'text-rose-50 bg-rose-800' : 'hover:bg-rose-100 hover:text-rose-800' }}">
                <span>Dosen</span>
            </a>
        </li>
